...
#define QUAGGA_VERSION     "1.2.1" GIT_SUFFIX
...
#define QUAGGA_CONFIG_ARGS "--enable-vtysh --enable-user=root --enable-group=root --enable-vty-group=root -sysconfdir=/etc/quagga -localstatedir=/var/run/quagga"
